...
const FileInfo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { fileInfoContent } = $$props;
  let infoWidth = "0";
  let convertedFilePath = "";
  if ($$props.isOpen === void 0 && $$bindings.isOpen && isOpen !== void 0)
    $$bindings.isOpen(isOpen);
  if ($$props.fileInfoContent === void 0 && $$bindings.fileInfoContent && fileInfoContent !== void 0)
    $$bindings.fileInfoContent(fileInfoContent);
...
const currentDir = writable("HomeDir");
const Dirs_svelte_svelte_type_style_lang = "";
const css$4 = {
  code: ".CurrentDir.svelte-18w7tc3.svelte-18w7tc3{color:red}section.svelte-18w7tc3.svelte-18w7tc3{width:10%;overflow-y:auto;min-width:10%}section.svelte-18w7tc3 div.svelte-18w7tc3{display:flex;flex-direction:column;align-items:center;transition:300ms opacity}section.svelte-18w7tc3>div.svelte-18w7tc3:hover{opacity:0.5}",
  map: null
};
const Dirs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $currentDir, $$unsubscribe_currentDir;
  $$unsubscribe_currentDir = subscribe(currentDir, (value) => $currentDir = value);
  let { dirs = [] } = $$props;
  if ($$props.dirs === void 0 && $$bindings.dirs && dirs !== void 0)
    $$bindings.dirs(dirs);
  $$result.css.add(css$4);
  $$unsubscribe_currentDir();
  return `



<section class="svelte-18w7tc3">${dirs.length ? each(dirs, (item) => {
    return `<div class="${["svelte-18w7tc3", item === $currentDir ? "CurrentDir" : ""].join(" ").trim()}">${item === "HomeDir" ? `${validate_component(Icon, "Icon").$$render(
      $$result,
      {
      ...
      {},
      {}
    )}` : `${item === "PictureDir" ? `${validate_component(Icon, "Icon").$$render($$result, { icon: "uiw:picture", width: "30" }, {}, {})}` : `${item === "DownloadDir" ? `${validate_component(Icon, "Icon").$$render(
      $$result,
      {
      ...
      {},
      {}
    )}` : `${item === "DocumentDir" ? `${validate_component(Icon, "Icon").$$render($$result, { icon: "solar:document-bold", width: "30" }, {}, {})}` : `${item === "DesktopDir" ? `${validate_component(Icon, "Icon").$$render($$result, { icon: "ph:desktop", width: "30" }, {}, {})}` : `${item === "VideoDir" ? `${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:video", width: "30" }, {}, {})}` : ``}`}`}`}`}`}
      <p>${escape(item.slice(0, -3))}</p>
    </div>`;
  }) : `<p>loading</p>`}
</section>`;
});
...
const css$3 = {
  code: ".cantGoBack.svelte-12bsyrm{opacity:0.2}.backArrow.svelte-12bsyrm{transition:opacity 0.5s}.backArrow.svelte-12bsyrm:hover{opacity:0.5;cursor:pointer}",
  map: null
};
const BackButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $stackHistory, $$unsubscribe_stackHistory;
...
const NavSearch = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $stackHistory, $$unsubscribe_stackHistory;
  $$unsubscribe_stackHistory = subscribe(stackHistory, (value) => $stackHistory = value);
  let inputTxt = "";
  let path = "";
  ...
  async function updateSearchBar() {
    ...
    if (path === "HomeDir" || path === "PictureDir" || path === "DownloadDir" || path === "DocumentDir" || path === "DesktopDir" || path === "VideoDir") {
  ...
  $$unsubscribe_stackHistory();
  return `<form class="svelte-4snbzg"><input type="text" autocomplete="on" class="svelte-4snbzg"${add_attribute("value", inputTxt, 0)}>
  ${searchSuggestion && isInputFocused ? `<div class="searchSuggestions svelte-4snbzg">${each(searchSuggestion, (item) => {
    return `
        <li class="svelte-4snbzg">${escape(item.path)}</li>`;
  })}</div>` : ``}
</form>`;
});
...
const css = {
  code: ".Container.svelte-tm7t0n{height:100vh;overflow-y:clip;display:flex;flex-direction:column}section.svelte-tm7t0n{display:flex;height:100%;overflow-x:hidden}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="Container svelte-tm7t0n">${validate_component(Tabs, "Tabs").$$render($$result, {}, {}, {})}
  ${validate_component(Nav, "Nav").$$render($$result, {}, {}, {})}
  <section class="svelte-tm7t0n">${validate_component(Dirs, "Dirs").$$render($$result, {}, {}, {})}

    ${validate_component(DirFiles, "DirFiles").$$render($$result, {}, {}, {})}</section>
</div>`;
});
export {
  Page as default
